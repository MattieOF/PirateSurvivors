...
public class PirateSurvivors : ModuleRules
{
	public PirateSurvivors(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput", "UMG", "AIModule", "OnlineSubsystemSteam", "AdvancedSessions", "AdvancedSteamSessions" });
