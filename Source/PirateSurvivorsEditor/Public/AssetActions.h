...
UCLASS() class UAssetDefinition_WeaponStats : public UAssetDefinitionDefault { GENERATED_BODY() public: virtual FText GetAssetDisplayName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_""WeaponStats","Weapon Stats"); } virtual FLinearColor GetAssetColor() const override { return FLinearColor::Blue; }; virtual TSoftClassPtr<UObject> GetAssetClass() const override { return UWeaponStats::StaticClass(); } virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override { static const auto Categories = { EAssetCategoryPaths::Basic / LOCTEXT("PirateAssetSubMenu", "Pirate Survivors") }; return Categories; } };
...
UCLASS() class UAssetDefinition_EncounterData : public UAssetDefinitionDefault { GENERATED_BODY() public: virtual FText GetAssetDisplayName() const override { return NSLOCTEXT("AssetTypeActions", "AssetTypeActions_""EncounterData","Encounter Data"); } virtual FLinearColor GetAssetColor() const override { return FLinearColor::Red; }; virtual TSoftClassPtr<UObject> GetAssetClass() const override { return UEncounterData::StaticClass(); } virtual TConstArrayView<FAssetCategoryPath> GetAssetCategories() const override { static const auto Categories = { EAssetCategoryPaths::Basic / LOCTEXT("PirateAssetSubMenu", "Pirate Survivors") }; return Categories; } };
